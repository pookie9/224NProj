...
tf.app.flags.DEFINE_float("dropout", 0.40, "Fraction of units randomly dropped on non-recurrent connections.") # 0.15
tf.app.flags.DEFINE_integer("batch_size", 100, "Batch size to use during training.")
tf.app.flags.DEFINE_integer("epochs", 10, "Number of epochs to train.")
tf.app.flags.DEFINE_integer("state_size", 200, "Size of each model layer.")
tf.app.flags.DEFINE_integer("output_size", 350, "The output size of your model.") #766 #600
...
tf.app.flags.DEFINE_string("run_name", "stacked_encoder_decoder", "Name to save the .ckpt file") # 60
