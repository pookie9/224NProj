...
class BiLSTM(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            b_z=tf.get_variable("b_z",shape=[self._state_size,],initializer=tf.contrib.layers.xavier_initializer())#init with zeros?
            ...
            b_r=tf.get_variable("b_r",shape=[self._state_size,],initializer=tf.contrib.layers.xavier_initializer())#init with zeros?
            ...
            b_o=tf.get_variable("b_o",shape=[self._state_size,],initializer=tf.contrib.layers.xavier_initializer())#init with zeros?
