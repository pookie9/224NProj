...
class Encoder(object):
    ...
    def encode(self, inputs, masks, encoder_state_input):
        ...
        (outputs, output_states)=bidirectional_dynamic_rnn(cell_fw,cell_bw,inputs,sequence_length=None,initial_state_fw=encoder_state_input,initial_state_bw=encoder_state_input,sequence_length=masks) #Maybe incorrect initial states? https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/ops/rnn.py#L313
...
class QASystem(object):
    def __init__(self, encoder, decoder,pretrained_embeddings, *args):
        """
